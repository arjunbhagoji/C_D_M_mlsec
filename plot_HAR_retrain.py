...
for item in list_dim:
    ...
    path_curr=abs_path_o+'HAR_Gradient_attack_SVM_PCA_retrain_unaware'+str(item)+'.txt'
    curr_array=np.genfromtxt(path_curr,delimiter=',',skip_header=20)
...
plt.title('Re-training defense for HAR data \n Model: Linear SVM')
# plt.ylim(0.0,100.0)
# plt.xlim(0.01,0.1)
plt.xticks()
...
#plt.show()
plt.savefig(abs_path_p+'HAR_SVM_PCA_retrain_unaware_pure_adv.png', bbox_inches='tight')

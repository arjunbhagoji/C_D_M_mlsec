...
for item in list_dim:
    ...
    path_curr=abs_path_o+'FSG_MNIST_data_hidden_2_100_w_PCA_clean'+str(item)+'.txt'
    curr_array=np.genfromtxt(path_curr,delimiter=',',skip_header=11)
...
plt.title('Reconstruction defense for MNIST data against FSG attack \n Model: FC100-100-10')
# plt.ylim(0.0,100.0)
plt.xlim(0.01,0.1)
plt.xticks()
...
#plt.show()
plt.savefig(abs_path_p+'MNIST_NN_2_PCA_recons_pure_adv.png', bbox_inches='tight')

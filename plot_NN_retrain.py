...
for item in list_dim:
    ...
    path_curr=abs_path_o+'FSG_MNIST_NN_2_100_retrain_PCA_unaware_'+str(item)+'.txt'
...
#plt.show()
plt.savefig(abs_path_p+'MNIST_NN_2_PCA_aware_retrain_pure_adv.png', bbox_inches='tight')

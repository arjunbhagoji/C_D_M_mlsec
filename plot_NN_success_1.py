...
recons,=plt.plot(x,curr_array[:,1],label='Reconstructed',marker='o')

curr_array=np.genfromtxt(abs_path_o+'MNIST_test_perform_PCA.txt',skip_header=0,delimiter=',')
retrained,=plt.plot(x,curr_array[:,1],label='Retrained',marker='x')
...
plt.savefig(abs_path_p+'MNIST_Class_success_PCA_NN_2.png', bbox_inches='tight')

...
for item in list_dim:
    ...
    path_curr=abs_path_o+'Gradient_attack_SVM_PCA_'+str(item)+'.txt'
    curr_array=np.genfromtxt(path_curr,delimiter=',',skip_header=52)
...
plt.title('Resilience of re-trained classifier to strategic attack \n Model: Linear SVM')
# plt.ylim(0.0,100.0)
# plt.xlim(0.01,0.1)
plt.xticks()

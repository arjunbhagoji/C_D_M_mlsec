...
for item in list_dim:
    ...
    path_curr=abs_path_o+'Gradient_attack_SVM_PCA_recons'+str(item)+'.txt'
...
plt.title('Impact of reconstruction step on adversarial perturbations (MNIST) \n Model: Linear SVM')
# plt.ylim(0.0,100.0)
# plt.xlim(0.01,0.1)
plt.xticks()
...
plt.legend(loc=2)
#plt.show()
plt.savefig(abs_path_p+'MNIST_recons_perturb_removal.png', bbox_inches='tight')
